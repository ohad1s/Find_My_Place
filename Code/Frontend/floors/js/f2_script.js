...
function generatePage(data) {
    ...
    const photoHtml = '<div><img src="../img/f2.jpeg" alt="A photo"></div>\n';

    // Create the "Return" button HTML content
    const buttonHtml = '<div class="navbar"><button class="home-button" onclick="window.location.href=\'../../html/index.html\';">Home</button></div>\n';
